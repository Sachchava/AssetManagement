            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!isPasswordValid(password)) {
                        react_toastify_1.toast.warn("password must be 8digits");
                        return [2 /*return*/];
                    }
                    e.preventDefault();
                    _b.label = 1;
                ...
                case 2:
                    ...
                    if (response.status === 200) {
                        react_toastify_1.toast.success("Created successfully");
                        navigate("/", {
                            state: {
                                username: email
                            }
        ...
        react_1["default"].createElement("div", { className: "divb" },
            ...
            react_1["default"].createElement("div", { className: "div2b" },
                react_1["default"].createElement("form", { className: "form", onSubmit: handleSubmit },
                    ...
                    react_1["default"].createElement("button", { type: "submit", className: "submitbutton" }, "Create"),
                    errorMessage && react_1["default"].createElement("p", { className: "errormessage" }, errorMessage),
                    react_1["default"].createElement("a", { href: "#", className: "registerlink", onClick: function () { return navigate("/"); } }, "Login"))),
